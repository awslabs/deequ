...
/**
  ...
  */
case class MutualInformationOp(columns: Seq[String]) extends FrequencyBasedOperator(columns) {
...
object MutualInformationOp {
  def apply(columnA: String, columnB: String): MutualInformationOp = {
    new MutualInformationOp(columnA :: columnB :: Nil)
  }
}
