...
/**
  ...
  */
case class ApproxCountDistinctOp(column: String, where: Option[String] = None)
  extends StandardScanShareableOperator[ApproxCountDistinctState]("ApproxCountDistinct", column) {
