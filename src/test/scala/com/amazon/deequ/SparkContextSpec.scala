...
/** To be mixed with Tests so they can use a default spark context suitable for
  * testing
  */
trait SparkContextSpec {

  /** @param testFun
    *   thunk to run with SparkSession as an argument
    */
  ...
  /** @param testFun
    *   thunk to run with SparkSession and SparkMonitor as an argument for the
    *   tests that would like to get details on spark jobs submitted
    */
  def withMonitorableSparkSession(
      testFun: (SparkSession, SparkMonitor) => Any
  ): Unit = {
  ...
  /** @param testFun
    *   thunk to run with SparkContext as an argument
    */
  ...
  /** @param testFun
    *   thunk to run with SQLContext as an argument
    */
