...
//    val size = Size(where)
//
//    val constraint = StatisticBasedConstraint[Double, Long](size,
...
//
//    val constraint = StatisticBasedConstraint[Distribution, Distribution](
...
//    val histogram = Histogram(column, maxBins)
//
//    val constraint = StatisticBasedConstraint[Distribution, Long](histogram, assertion, Some(_.numberOfBins), hint)
//
...
//
//    val constraint = StatisticBasedConstraint[Double, Double](completeness, assertion, hint = hint)
//
...
//    : Constraint = {
//
//    val constraint = StatisticBasedConstraint[Double, Double](statistic, anomalyAssertion, hint = hint)
//
//    new NamedConstraint(constraint, s"AnomalyConstraint($statistic)")
//  }
//
//  /**
...
//
//    val constraint = StatisticBasedConstraint[Double, Double](uniqueness, assertion, hint = hint)
//
...
//
//    val constraint = StatisticBasedConstraint[Double, Double](distinctness, assertion, hint = hint)
//
...
//    val constraint = StatisticBasedConstraint[Double, Double](uniqueValueRatio, assertion, hint = hint)
//
