...
import com.amazon.deequ.statistics.{Compliance, DataTypeInstances, Histogram}
...
case class CategoricalRangeRule() extends ConstraintRule[ColumnProfile] {
  ...
  override def candidate(profile: ColumnProfile, numRecords: Long): ConstraintSuggestion = {
    ...
    val constraint =
      StatisticConstraint[Double, Double](Compliance(description, columnCondition), Check.IsOne)
