...
private[sql] case class StatefulSkewness(
  child: Expression,
  ...
  override def dataType: DataType = StructType(
    ...
    StructField("m3", DoubleType) :: Nil)

  override val evaluateExpression: Expression =
    CreateStruct(n :: avg :: m2 :: m3 :: Nil)

  override def prettyName: String = "stateful_skewness"

  protected def withNewChildInternal(
      newChild: Expression): StatefulSkewness =
    copy(child = newChild)
}
