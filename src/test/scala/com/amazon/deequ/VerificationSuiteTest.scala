...
import com.amazon.deequ.anomalydetection.{AbsoluteChangeStrategy, AnomalyDetectionDataPoint, AnomalyDetectionExtendedResult, Bound, Threshold}
      ...
      evaluateWithRepositoryWithHistory { repository =>
        ...
        val actualResultsOneAnomalyDetectionDataPoint =
          verificationResultOne.checkResults.head._2.constraintResults.head
            .anomalyDetectionExtendedResultOption.get.anomalyDetectionDataPoints.head
        val expectedResultsOneAnomalyDetectionDataPoint =
          AnomalyDetectionDataPoint(11.0, 7.0, Threshold(Bound(-2.0), Bound(2.0)), isAnomaly = true, 1.0)
        ...
        val expectedResultsTwoAnomalyDetectionDataPoint =
          AnomalyDetectionDataPoint(11.0, 0.0, Threshold(Bound(-7.0), Bound(7.0)), isAnomaly = false, 1.0)
